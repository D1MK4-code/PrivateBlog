...
const CommentsForm = ({slug}) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="mt-8">
        <button type="button" onClick={handleCommentSubmission} className="transition duration-300 ease hover:bg-indigo-900 inline-block bg-pink-600 text-md rounded-full text-white px-6 py-2 cursor-pointer">
          Post comment
        </button>
